...
function KoshhPage() {
  const { hero, introLine, spotlight, features, featuresHeading, meta } = MARKETING_CONTENT.koshh;
  ...
  return (
    <PageLayout headerMode="overlay">
      <section className="brand-hero-quiet overflow-hidden pt-10 md:pt-14">
        <Hero
          dark
          ...
          containerClassName="pb-24 md:pb-28"
          actions={[
            <PrimaryButton
              key="koshh"
